import foodFlyerImage from "./assets/food-flyer-img.jpg";
import algoVisionaryImage from "./assets/algo-visionary-img.jpg";
import netflixGptImage from "./assets/netflix-gpt-img.jpg";
import braintum from "./assets/braintum.jpg";
import smartAttendance from "./assets/smart-attendance-img.webp";
...
export const techStack = [
  ...
  { name: "Vercel", link: "https://github.com/devicons/devicon/tree/v2.16.0/icons/vercel/vercel-plain.svg" },
  ...
  { name: "GitHub", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/gitHub/gitHub-plain.svg" },
...
{ name: 'Instagram', url: 'https://img.icons8.com/doodle/40/000000/instagram-new--v2.png', link: 'https://www.instagram.com/praneeeethh/' },
{ name: 'Github', url: 'https://img.icons8.com/doodle/40/000000/github--v1.png', link :'https://github.com/praneethgourla18'},
{ name: 'LinkedIn', url: 'https://img.icons8.com/doodle/40/000000/linkedin--v2.png', link: 'https://www.linkedin.com/in/praneethgourla/'}
]
...
export const projectsData = [
  ...
  },
  {
    ...
    repoLink: "https://github.com/praneethgourla18/Food-Flyer",
    workInProgress: false,
    demoLink: "https://food-flyer.vercel.app/",
    imageUrl: foodFlyerImage,
  },
  {
    title: "Algo Visionary",
    description: "Visualize complex algorithms easily!",
    repoLink: "https://github.com/praneethgourla18/Algo-Visionary",
    workInProgress: false,
    demoLink: "https://algo-visionary.vercel.app/",
    imageUrl: algoVisionaryImage,
  },
  {
    title: "Food Flyer server",
    description: "Food delivery web application - backend.",
    repoLink: "https://github.com/praneethgourla18/Food-Flyer-Server",
    workInProgress: false,
    demoLink: "https://food-flyer-server.vercel.app/",
    imageUrl: foodFlyerImage,
  },
  {
    title: "Hybrid U-net CNN framework for multiclass brain tumor segmentation",
    description: "Brain tumor segmentation using Deep-learning.",
    repoLink: "https://github.com/praneethgourla18/Hybrid-Unet---Cnn-Framework-For-Robust-Brain-Tumor-Segmentation-In-3D-Mri",
    workInProgress: false,
    demoLink: null,
    imageUrl: braintum,
  },
  {
    title: "Smart Attendance System Using CNN",
    description: "Smart attendance system using Facial recognition.",
    repoLink: null,
    workInProgress: false,
    demoLink: null,
    imageUrl: smartAttendance,
  }
];